...
<div class="w-[100px] bg-white flex flex-col justify-between border-r-[1px]">
    <div class="">
        <a href="/admin" on:click={() => selected(1)} class="h-[80px] flex flex-col justify-center">
            <button class=" rounded-e-[100px] w-[90%]" id="1" >
                <LogoIcon src="https://cdn-icons-png.flaticon.com/512/35/35771.png" title="Profile"/>
            </button>
        </a>
        <div class="h-0 w-full border-[2px] border-solid border-zinc-400"></div>
        <a href="/admin/user" on:click={() => selected(2)} class="h-[80px] flex flex-col justify-center">
            <button class="rounded-e-[100px] w-[90%]" id="2" >
                <LogoIcon src="https://cdn-icons-png.flaticon.com/512/1077/1077063.png" title="Users"/>
            </button>
        </a>
        <div class="h-0 w-full border-[2px] border-solid border-zinc-400"></div>
    </div>
